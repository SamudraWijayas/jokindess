...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-6 py-16 text-white" id="paket">
      <h1 className="text-4xl md:text-5xl font-extrabold mb-4 text-center text-black dark:text-white">
        Investasi Terbaik untuk Website Anda
      </h1>
      <p className="text-center mb-12 max-w-2xl text-gray-600 text-lg dark:text-white">
      ...
      {/* <ModalPaket isOpen={isOpen} onClose={handleClose} /> */}
    </div>
  );
}
